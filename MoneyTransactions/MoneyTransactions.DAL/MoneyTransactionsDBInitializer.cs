...
namespace MoneyTransactions.DAL
{
    public class MoneyTransactionsDBInitializer : DropCreateDatabaseIfModelChanges<MoneyTransactionsContext>
    {
        protected override void Seed(MoneyTransactionsContext context)
        {
            ...
            context.Accounts.Add(new Entities.Account
            {
                AccountID = Guid.Parse("12f39e21-704e-4481-8b85-07d3cf74782"),
                Email = "angelo.batz@windler.com",
                NickName = "Mcdonella",
                Password = "Mcdonella",
                Phone = "062627558471",
                UserName = "edgy",
            ...
            context.CryptocurrencyStores.Add(new Entities.CryptocurrencyStore
            {
                CryptocurrencyStoreID = Guid.Parse("9c5e0dd2-840a-42d9-bd31-0a7c31194ec8"),
                MoneyType = "BTC",
                Description = "",
                FloorPrice = 204020000
            });
            context.CryptocurrencyStores.Add(new Entities.CryptocurrencyStore
            {
            ...
            // Orders
            context.Orders.Add(new Entities.Order { Amount = 9.12343m, Price = 0, CreatedDate = DateTime.Parse("2019-09-12 03:15:30.12345"), ModifiedDate = DateTime.Parse("2019-09-12 03:15:30.12345"), OrderID = Guid.Parse("51e3fb71-c014-4bb1-a77c-38460e8f0ca5"), WalletID = Guid.Parse("4e0100cf-61eb-4e80-8293-2873d8bd8fd8") });
            context.Orders.Add(new Entities.Order { Amount = 0.12411m, Price = 0, CreatedDate = DateTime.Parse("2019-08-22 22:01:30.12345"), ModifiedDate = DateTime.Parse("2019-08-22 22:01:30.12345"), OrderID = Guid.Parse("67600943-2897-45f6-bd2a-f014d2743ec1"), WalletID = Guid.Parse("a3eeb73c-9c53-4d00-8ec3-1772de65f03a") });
            context.Orders.Add(new Entities.Order { Amount = 0.00228m, Price = 0, CreatedDate = DateTime.Parse("2019-11-13 23:19:30.12345"), ModifiedDate = DateTime.Parse("2019-11-13 23:19:30.12345"), OrderID = Guid.Parse("749161a8-f2a7-433d-b2b8-03d9d7b5e212"), WalletID = Guid.Parse("5a9b86f9-421f-45fb-9988-2c8571bce530") });
            context.Orders.Add(new Entities.Order { Amount = 3.41345m, Price = 0, CreatedDate = DateTime.Parse("2019-03-09 01:05:30.12345"), ModifiedDate = DateTime.Parse("2019-03-09 01:05:30.12345"), OrderID = Guid.Parse("b2fcc381-c9e5-4732-a0d8-d3fdda5297d0"), WalletID = Guid.Parse("1a448449-0bba-4ea1-a3c9-94cb3341f03c") });
            context.Orders.Add(new Entities.Order { Amount = 1.12232m, Price = 0, CreatedDate = DateTime.Parse("2019-02-22 07:11:30.12345"), ModifiedDate = DateTime.Parse("2019-02-22 07:11:30.12345"), OrderID = Guid.Parse("4b741272-eaa0-490c-bdcc-8e97d5245228"), WalletID = Guid.Parse("2893ad6a-e856-4ce4-bc2e-0a0bdd89a06b") });
            context.Orders.Add(new Entities.Order { Amount = 3.49553m, Price = 0, CreatedDate = DateTime.Parse("2019-01-30 06:20:30.12345"), ModifiedDate = DateTime.Parse("2019-01-30 06:20:30.12345"), OrderID = Guid.Parse("4ac1767f-d5da-4051-bfe8-1de6484b1095"), WalletID = Guid.Parse("ebd1ee86-9647-40e8-9eda-7971e348ee8c") });
            context.Orders.Add(new Entities.Order { Amount = 2.36815m, Price = 0, CreatedDate = DateTime.Parse("2019-06-10 20:03:30.12345"), ModifiedDate = DateTime.Parse("2019-06-10 20:03:30.12345"), OrderID = Guid.Parse("df377153-5165-4130-9329-b80eaf92031e"), WalletID = Guid.Parse("c1fe5d6e-7fef-467f-99d4-3742985bc2ed") });
            context.Orders.Add(new Entities.Order { Amount = 4.84348m, Price = 0, CreatedDate = DateTime.Parse("2019-10-27 21:02:30.12345"), ModifiedDate = DateTime.Parse("2019-10-27 21:02:30.12345"), OrderID = Guid.Parse("e2c84406-fbc8-43ca-b6f0-918dbe8df608"), WalletID = Guid.Parse("65213311-9616-422e-9c9d-1f33711836b2") });
            context.Orders.Add(new Entities.Order { Amount = 2.77118m, Price = 0, CreatedDate = DateTime.Parse("2019-08-30 06:17:30.12345"), ModifiedDate = DateTime.Parse("2019-08-30 06:17:30.12345"), OrderID = Guid.Parse("3fabc416-372c-4a07-b2cb-66984f344330"), WalletID = Guid.Parse("c9977ae2-60cf-45c1-a5ae-6e96bd9ea529") });
            context.Orders.Add(new Entities.Order { Amount = 4.65678m, Price = 0, CreatedDate = DateTime.Parse("2019-12-18 10:10:30.12345"), ModifiedDate = DateTime.Parse("2019-12-18 10:10:30.12345"), OrderID = Guid.Parse("cc5f6c41-7bf8-4ed0-98d5-8c7af1d86574"), WalletID = Guid.Parse("93b94127-07f7-4c7a-88db-a38f5300b501") });
